                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="/SchoolConstructorManagement/addreport" method="post">
                                <div class="mb-3">
                                        <label for="reportId" class="form-label">Mã báo cáo</label>
                                        <input type="text" class="form-control" id="reportId"
                                            name="reportId">
                                    </div>
                                	<div class="mb-3">
                                        <label for="reportName" class="form-label">Tên báo cáo</label>
                                        <input type="text" class="form-control" id="reportName"
                                            name="reportName">
                                    </div>
                                    <div class="mb-3">
                                        <label for="reportDate" class="form-label">Ngày viết báo cáo</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="reportProgress" class="form-label">
                                        </label>
                                        <textarea class="form-control" id="reportProgress" rows="3"
                                            name="reportProgress"></textarea>
                                    </div>
                                    <h2>Tài Nguyên Nguồn Lực</h2>
                                    <p>Mô tả tình trạng sử dụng nhân sự và vật liệu theo kế hoạch.</p>

                                    <div class="mb-3">
                                        <label for="reportResource" class="form-label">
                                        </label>
                                        <textarea class="form-control" id="reportResource"
                                            rows="3" name="reportResource"></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="challenge"
                                            rows="3" name="challenge"></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="nextPlan" class="form-label">
                                        </label>
                                        <textarea class="form-control" id="nextPlan"
                                            rows="3" name="nextPlan"></textarea>
                                    </div>
