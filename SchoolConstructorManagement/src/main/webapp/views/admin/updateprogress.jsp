...
<body>
	...
	<div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<div class="container-fluid pt-4 px-4">
			<div class="card">
			<div class="card-body">
				<h5 class="card-title">Sửa tiến trình</h5>

				<!-- Multi Columns Form -->
				<form class="row g-3" action="/SchoolConstructorManagement/updateprogress"
					method="post">
					<c:set var="pg" value="${requestScope.progress }"></c:set>
					<div class="col-md-12">
						<label class="form-label">Mã tiến trình</label> <input type="text"
							class="form-control" name="progressid" readonly="readonly" value="${progress.progressid }">
					</div>
					<div class="col-md-6">
						<label class="form-label">Ngày cập nhật</label> <input type="date"
							class="form-control" name="updatedate" value="${progress.updatedate }">
					</div>
					<div class="col-12">
						<label class="form-label">Mô tả</label> <input type="text"
							class="form-control" name="progressdescription" value="${progress.progressdescription }">
					</div>
					<div class="col-12">
						<label class="form-label">Mã dự án</label> <input type="text"
							class="form-control" name="status" value="${progress.status }">
					</div>
					<div class="col-12">
						<label class="form-label">Mã dự án</label> <input type="text"
							class="form-control" name="progressdescription" value="${progress.projectid }">
					</div>
