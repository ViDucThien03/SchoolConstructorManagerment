	...
	<div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="/SchoolConstructorManagement/addresource"
					method="post">
					<c:if test="${requestScope.error != null}">
						<p class="text-danger mt-2">${requestScope.error}</p>
					</c:if>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Mã tài nguyên</label>
                  <input type="text" class="form-control" name="resourceId">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">Tên tài nguyên</label>
                ...
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Mã dự án</label>
