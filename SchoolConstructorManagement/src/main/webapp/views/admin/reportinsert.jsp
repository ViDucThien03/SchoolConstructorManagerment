                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                     		<a href="/SchoolConstructorManagement/addreport" class="btn btn-primary">Tạo báo cáo</a>
                     		<a href="/SchoolConstructorManagement/listreport" class="btn btn-primary" >Xem các báo cáo trước đó</a>
                    </div>
                </div>
            </div>	
            <!-- Table End -->
